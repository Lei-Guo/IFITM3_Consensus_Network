...
Rscript -e "rmarkdown::render('correlation_ifitm3_all_gene.Rmd')"
...
# BM10
expr_ifitm3_ad_bm10_t <- t(expr_bm10_ad["ENSG00000142089", ])
expr_bm10_ad_t <- t(expr_bm10_ad)

# BM22
expr_ifitm3_ad_bm22_t <- t(expr_bm22_ad["ENSG00000142089", ])
expr_bm22_ad_t <- t(expr_bm22_ad)

# BM36
expr_ifitm3_ad_bm36_t <- t(expr_bm36_ad["ENSG00000142089", ])
expr_bm36_ad_t <- t(expr_bm36_ad)

# BM44
expr_ifitm3_ad_bm44_t <- t(expr_bm44_ad["ENSG00000142089", ])
expr_bm44_ad_t <- t(expr_bm44_ad)

# ROSMAP
expr_ifitm3_ad_rosmap_t <- t(expr_rosmap_ad["ENSG00000142089", ])
expr_rosmap_ad_t <- t(expr_rosmap_ad)

# HBTRC CR
expr_ifitm3_ad_rc_t <- t(expr_hb_rc[c("10025912066", "10033668462"), ])
expr_hb_rc_t <- t(expr_hb_rc)

# HBTRC PFC
expr_ifitm3_ad_pfc_t <- t(expr_hb_pfc[c("10025912066", "10033668462"), ])
expr_hb_pfc_t <- t(expr_hb_pfc)

# HBTRC VC
expr_ifitm3_ad_vc_t <- t(expr_hb_vc[c("10025912066", "10033668462"), ])
expr_hb_vc_t <- t(expr_hb_vc)
```



Correlation analysis between ifitm3 and genes in each AD dataset
```{r Correlation analysis between ifitm3 and genes in each AD dataset}
# ifitm3 AD expression list
expr_t_ls_ifitm3 <- list(expr_ifitm3_ad_bm10_t, expr_ifitm3_ad_bm22_t, expr_ifitm3_ad_bm36_t, expr_ifitm3_ad_bm44_t, expr_ifitm3_ad_rosmap_t, expr_ifitm3_ad_rc_t, expr_ifitm3_ad_pfc_t, expr_ifitm3_ad_vc_t)
...
# correlation test
cor_results <- mapply(corRhoPvalSpearmanPearson_TwoMatrices, expr_t_ls_ifitm3, expr_t_ls, SIMPLIFY = F)
...
output_names <- paste0("/sc/orga/projects/zhangb03a/lei_guo/IFITM3/Corr_Results/", c("IFITM3_gene_cor_test_bm10.csv", "IFITM3_gene_cor_test_bm22.csv", "IFITM3_gene_cor_test_bm36.csv", "IFITM3_gene_cor_test_bm44.csv", "IFITM3_gene_cor_test_rosmap.csv", "IFITM3_gene_cor_test_hbcr.csv", "IFITM3_gene_cor_test_hbpfc.csv", "IFITM3_gene_cor_test_hbvc.csv"))
